...
import BackToHome from "../helpers/BackToHome";
            ...
            <div className="container  w-full  ">
              <div className="flex lg:w-screen lg:flex-row flex-col justify-center lg:justify-between lg:items-start ">
                <div className="w-auto md:px-10">
                  ...
                  >
                    <h2 className="mb-6  font-dm text-4xl font-bold tracking-tight text-center text-gray-900 sm:text-5xl sm:leading-none">
